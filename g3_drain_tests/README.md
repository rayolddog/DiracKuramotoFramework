...
Reproduce: `python3 drain_variants.py` (~4 min), `python3 exchange_kernel.py` (~20 min), `python3 theorem5_check.py` (~2 min), `python3 threshold_gated_commit.py` (2-site and 10-site grids in ~8 min; the 100-site grid takes the total to ~7 h; at N = 100 no gate, linear or Arrhenius, moves the outcome).
