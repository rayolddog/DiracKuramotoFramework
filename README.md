...
| **One World, One Cut — publication candidate** (short form, 2026-09-04) | [drafts/PAPER_one_world_one_cut_SHORT.md](drafts/PAPER_one_world_one_cut_SHORT.md) · [PDF v1.3](One_World_One_Cut_short_v1.3.pdf) · [v1.2](One_World_One_Cut_short_v1.2.pdf) · [v1.1](One_World_One_Cut_short_v1.1.pdf) · [v1.0 frozen](One_World_One_Cut_short_v1.0.pdf) | v1.3 (2026-09-05, the identified post-review revision: the sponsor's shared-waveform picture written in as the no-jump renormalization; order-independence experiments cited), revised after the four-reviewer internal round in [one_world_one_cut_AI_review_2026-09/](one_world_one_cut_AI_review_2026-09/): the postulate restated as the quantum-jump unravelling read as ontic after the record's own model falsified the v1.0 hazard for staggered arrival; the cut's location given its regime (coupling-set for Γ ≪ K, record-set for Γ ≫ K); the in-principle claim conceded; the transactional comparison rewritten against the sources; frame tests withdrawn; the paper's one result stated as a no-go |
