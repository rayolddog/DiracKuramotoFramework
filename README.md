...
| **One World, One Cut — publication candidate** (short form, 2026-09-04) | [drafts/PAPER_one_world_one_cut_SHORT.md](drafts/PAPER_one_world_one_cut_SHORT.md) · [PDF](One_World_One_Cut_short_v1.0.pdf) | v1.0: the interpretation without its development history; relations to decoherence, Everett, collapse models, Bohm/Nelson, the transactional interpretation, Curie–Weiss and Copenhagen put first; every number cited to the record |
