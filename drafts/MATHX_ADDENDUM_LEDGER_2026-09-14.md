...
| M-9 | removal of an anticipated finding, pre-freeze | MathX `vacuum_race/` addenda 2 and 2b, Table 8, L28 | Addendum A.7; review ledger item 3 | Applied 2026-09-14 (night): the staggered-arrival failure the review ledger anticipated for the race is reproduced (survival hazard: the nearer port from a tenth of a packet length) and removed (rates on the normalized conditional state: Born at every stagger and coupling). A local repair with the ports coupled only by the stop gives 0.952, a registered miss kept in MathX. A.7's premise 2 amended; the ledger item marked removed with its price, P5's second face. |
| M-10 | consistency pass (v0.11) | review round `findings_classification.md` N5, N6, N7, N8, N12, N13, N15, convergence 2 and 3 | Paper 1 abstract, §1, Table 1, Table 2, §5.5, §5.4, §8.2, A.1–A.4, A.7, A.8; `NEGATIVE_RESULT.md`; `README.md`; `AUTHORSHIP.md` | Applied 2026-09-14 (late) at the sponsor's instruction, with the MathX sessions of 09-08 and 09-14 deciding where documents disagreed. Withdrawn phrases quoted in place. M-8's Grangier correction was itself wrong (photomultipliers, not silicon) and is corrected in A.3. Claim-level findings (N3, N8, N11, convergence 1 beyond wording) not taken. |
