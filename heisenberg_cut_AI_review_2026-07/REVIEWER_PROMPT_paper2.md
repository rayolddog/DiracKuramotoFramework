...
> **Access-mode equalization (protocol addition this round):** you are explicitly invited to consult the public repository referenced in the manuscript ([Framework repository] in its reference list), including the companion paper and its published review round, to check provenance, code, and authorship claims. At the top of your review, record: (a) whether you are running web-enabled, and (b) whether you followed the repository pointer. Both answers are published with your review.
