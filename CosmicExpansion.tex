...
The DK framework {[}companion paper{]} proposes that quantum measurement
consists of three stages: (Stage 1) resonant pair-capture of a perturbed
partner by a macroscopic \emph{bulk} characterized by an order-parameter
phase \(\Phi_{\text{bulk}}\); (Stage 2) selection --- the surface commit
that sets the outcome weights; and (Stage 3) irreversible registration
of the partner against the bulk. The dissipative re-equilibration
(Stages 2--3; the ``Stage 2'' of the framework's earlier two-stage form)
proceeds via two parallel rate channels,
...
gravitational self-relocking rate of the bulk. Stage-3 registration
events are the rare bath-coupling moments that produce classical,
irreversible measurement records.
...
Stages-2--3 relaxation rates Γ\_env(T) and Γ\_grav(M) that vanish in
